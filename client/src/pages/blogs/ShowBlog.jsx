    ...
    return (
        ...
        <div className="bg-light min-vh-100 mt-3">
            ...
            <div className="position-relative overflow-hidden">
                {blog.image && (
                    <div className="hero-image position-relative" style={{ height: '60vh' }}>
                        <img
                            src={blog.image}
                            alt={blog.title}
            ...
            <div className="container py-5">
                <div className="row justify-content-center">
                    <div className="col-12 col-lg-8">
                        {/* Article Header */}
                        <div className="bg-white rounded-4 shadow-lg p-5 mb-4" style={{ marginTop: blog.image ? '-8rem' : '0', position: 'relative', zIndex: 10 }}>
                            ...
                            <div className="d-flex flex-wrap align-items-center gap-4 mb-4 pb-4 border-bottom">
                                ...
                                <div className="d-flex align-items-center text-muted">
                                    ...
                                    <span>{calculateReadTime(blog.description || blog.content)}</span>
                                </div>
                            </div>
                            ...
                            <div className="article-content">
                                ...
                                <div className="fs-5 lh-lg text-dark" style={{ lineHeight: '1.8' }}>
